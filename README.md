...
Navigate to the `*/home/user/WheatGP/GUI`* directory and run the GUIcode.py script. The **GUI** will then start, and the result interface is shown in the figure below.
...
- **Email**: [liuping@sdau.edu.cn](); [lixiang@sdau.edu.cn]()
